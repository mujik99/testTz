...
window.io = __webpack_require__(25);
...
window.Echo.channel('postUpdate').listen('GetNewPostsEvent', function (data) {
    ...
    for (var i = 0; i < data.posts.length; i++) {
        ...
        var post = '<div class="post">' + '<div class="post_title">' + data.posts[i].post_title + '</div>' + '<div class="post_content">' + '<div class="post_img"><img src="' + imgPath + '" alt="photo"></div>' + '<div class="post_description">' + data.posts[i].description + '</div>' + '<div class="clear"></div>' + '</div>' + '<div class="post_author">' + data.posts[i].author_name + '</div>' + '<div class="post_date">' + data.posts[i].created_at + '</div>' + '<div class="clear"></div>' + '</div>';
        posts += post;
    }
    $('.posts').html(posts);
});
